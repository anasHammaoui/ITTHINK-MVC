        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <form action="/register" method="post" class="space-y-6">
                    ...
                    <div>
                        <input type="password" name="password_confirmed" id="password_confirmed" placeholder="**********"
                               class="w-full px-4 py-2 text-gray-700 bg-white rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            <input type="radio" name="role" id="freelancer" value="3" checked
                                   class="w-5 h-5 text-indigo-500 focus:ring-indigo-500">
                            <label for="freelancer" class="ml-2">Freelancer</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="role" id="client" value="2"
                                   class="w-5 h-5 text-indigo-500 focus:ring-indigo-500">
                ...
                <div class="flex items-center justify-center mt-2">
                    ...
                    <a href="/login" class="text-indigo-500 ml-2">Log In</a>
                </div>
            </div>
        </div>
    </div>
